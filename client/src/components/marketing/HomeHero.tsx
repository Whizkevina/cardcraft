...
export function HomeHero({
  ...
  return (
    <MarketingSection id="home-hero" spacing="open" tone="grid" className="overflow-hidden border-b border-border/60">
      <div className="grid lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] gap-12 lg:gap-16 items-center">
        <div className="text-center lg:text-left">
          ...
          <h1 className={hpCn(hp.display, "text-4xl sm:text-5xl lg:text-[3.4rem] mt-5 mb-5")}>
            Cards worth sending.
            <span className="block mt-1 text-foreground/90">Built in minutes.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-3 mb-10">
            ...
            <Link href="/pricing" onClick={onViewPricing}>
              <Button size="lg" variant="ghost" className={hpCn(hp.btnSecondary, "w-full sm:w-auto text-muted-foreground")}>
                See pricing
              </Button>
            </Link>
          </div>

          <div className="grid grid-cols-3 gap-4 max-w-md mx-auto lg:mx-0 pt-6 border-t border-border/70">
            {stats.map(s => (
